...
export function IntelligenceEngine() {
  return (
    <section id="intelligence" className="py-24 bg-white border-t border-black scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
        
        <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-6">Marketing Intelligence Engine</h2>
            <div className="space-y-8">
                <div className="flex gap-4 p-4 bg-white rounded-xl border border-black">
                    <div className="w-12 h-12 flex-shrink-0 bg-[#FF6B35] rounded-full flex items-center justify-center">
                        <span className="text-white font-bold">01</span>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold text-black mb-2">Geo-Demand Analysis</h3>
                ...
                <div className="flex gap-4 p-4 bg-white rounded-xl border border-black">
                    <div className="w-12 h-12 flex-shrink-0 bg-orange-500 rounded-full flex items-center justify-center">
                        <span className="text-white font-bold">02</span>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold text-black mb-2">Competitor Mapping</h3>
                ...
                <div className="flex gap-4 p-4 bg-white rounded-xl border border-black">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-black mb-2">Smart Seasonal Bundles</h3>
        ...
        <div className="lg:w-1/2 relative">
             ...
             <div className="relative rounded-2xl overflow-hidden border border-black shadow-2xl">
                <img 
